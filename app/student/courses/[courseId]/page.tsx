  ...
  return (
    <motion.div className="space-y-8" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div variants={itemVariants} className="relative">
        {/* Wrapper to handle rounded top corners and clip the content */}
        <div className="overflow-hidden rounded-t-2xl md:rounded-t-3xl">
          <div className="bg-gradient-to-br from-emerald-600 to-teal-600 p-6 pt-4 pb-20 text-white md:p-8 md:pb-24">
            {/* Flex container to vertically center the button and badge and place them on the same line. */}
            ...
            <h1 className="text-3xl font-bold font-poppins md:text-4xl">{course.title}</h1>
        ...
        {/* Soft fade-out overlay. Positioned outside the clipping wrapper to fade into the page background. */}
      ...
      <motion.div
        ...
        className="relative z-10 -mt-16 grid grid-cols-1 gap-6 px-4 md:-mt-20 md:grid-cols-3 md:px-0"
      >
        <Card>
          <CardHeader>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center justify-center pt-4">
            ...
            <p className="mt-2 text-gray-500">Total Quizzes</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent className="flex flex-col items-center justify-center pt-4">
            ...
            <p className="mt-2 text-gray-500">Attendance Rate</p>
          </CardContent>
        </Card>
      </motion.div>
                      ...
                      {course.assignments.map((item: AssignmentDetail) => (
                        <TableRow key={item.id}>
                          ...
                          <TableCell className="flex items-center space-x-2">
                            <StatusIcon status={item.status} /> <span>{item.status}</span>
                          </TableCell>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  <GraduationCap className="h-5 w-5 mt-1 text-emerald-600" />
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  <User className="h-5 w-5 mt-1 text-emerald-600" />
                  <div>
